...
const About = () => {
  return (
    <div id='mission' className="page w-full flex flex-col items-center text-white justify-center h-screen bg-black">
       <h1 className='text-7xl uppercase font-bold mt-4 max-md:text-3xl max-md:w-1/2 max-md:text-center'>OUR MISSION & VISION</h1>
<div className="flex items-center justify-center max-md:flex-col">
  <div className="W-1/2 flex px-20 flex-col items-center justify-center max-md:w-full max-md:px-4">
...
We strive to empower students with a rich experience of coding and hone their skills to help them skyrocket themselves through this tech-realm of today. We Aim to nurture creativity, innovation through a lifelong love for coding.
  ...
  <img className='h-[80%] w-1/2 object-contain max-md:w-full' src={"/missionnew.png"} alt="" />
</div>
    </div>
  )
}
