...
const Page2 = () => {
  return (
    <div id='page2' className="page h-screen flex-col gap-0 flex items-center justify-center max-md:justify-around w-full bg-black text-white">
      <h1 className='text-7xl font-bold mt-4 max-md:text-5xl'>ABOUT US</h1>
